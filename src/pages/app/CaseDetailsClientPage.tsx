...
export default function CaseDetailsClientPage() {
    ...
    const renderContent = () => {
        switch (activeMenu) {
            case 'case-info':
                return <CaseInfo caseId={caseData.id} description={caseData.description} />;
            case 'timeline':
            ...
            <aside className="w-80 bg-white border-r border-gray-200 flex flex-col">
                ...
                <div className="p-6 border-b border-gray-200 bg-gradient-to-br from-primary to-midnight">
                    <div className="flex flex-col items-center text-center">
                        {/* Avatar */}
                        <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center mb-4 overflow-hidden border-2 border-white/30">
                            {lawyer?.avatarUrl ? (
                                <img 
